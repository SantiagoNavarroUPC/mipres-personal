...
export async function POST(request: NextRequest) {
  try {
    ...
    const endpoint = `${getBackendApiUrl()}/api/reportes/reserva-tecnica/plantilla/excel`
    ...
    return new NextResponse(buffer, {
      ...
      headers: {
        ...
        "Content-Disposition": response.headers.get("Content-Disposition") || "attachment; filename=\"plantilla_reserva_tecnica.xlsx\"",
