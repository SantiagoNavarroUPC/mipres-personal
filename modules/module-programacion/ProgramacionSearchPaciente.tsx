...
interface ProgramacionSearchPacienteProps {
  fecha: string
...
export function ProgramacionSearchPaciente({
  fecha,
  tipoDocumento,
  numeroDocumento,
  loading,
  ...
  onSearch,
}: ProgramacionSearchPacienteProps) {
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Busca las programaciones asociadas a un paciente en una fecha específica
        </CardDescription>
      </CardHeader>
      <CardContent>
