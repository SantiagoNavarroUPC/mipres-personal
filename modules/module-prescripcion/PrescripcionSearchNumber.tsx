...
interface PrescripcionSearchNumberProps {
  noPresc: string
  loading: boolean
...
export function PrescripcionSearchNumber({
  noPresc,
  loading,
  isConfigured,
  onNoPrescChange,
  onSearch,
}: PrescripcionSearchNumberProps) {
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Retorna toda la informacion del anexo tecnico por numero de prescripcion (20 caracteres)
        </CardDescription>
      </CardHeader>
      <CardContent>
