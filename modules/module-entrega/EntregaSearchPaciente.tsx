...
interface EntregaSearchPacienteProps {
  fecha: string
...
export function EntregaSearchPaciente({
  fecha,
  tipoDocumento,
  numeroDocumento,
  loading,
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Busca las entregas asociadas a un paciente en una fecha específica
        </CardDescription>
      </CardHeader>
      <CardContent>
